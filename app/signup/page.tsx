  ...
  return (
    <section id="signUp">
        <div className={`container ${styles.container}`}>
            <form onSubmit={handleSubmit} className="signUpForm" action="/signup" method="post">
                ...
                <div className={styles.content}>
                    <div id="formFirstName" className={styles.inputGroup}>
                        ...
                        <input value={signUpForm.firstName} onChange={onChange} className="input" type="text" id="firstName" />
                    </div>

                    <div id="formLastName" className={styles.inputGroup}>
                        <label htmlFor="firstName">Last name</label>
                        <input value={signUpForm.lastName} onChange={onChange} className="input" type="text" id="lastName" />
                    </div>

                    <div id="formEmail" className={styles.inputGroup}>
                        <label htmlFor="email">Email</label>
                        <input value={signUpForm.email} onChange={onChange} className="input" type="text" id="email" />
                    </div>

                    <div id="formPassword" className={styles.inputGroup}>
                        <label htmlFor="password">Password</label>
                        <input value={signUpForm.password} onChange={onChange} className="input" type="password" id="password" />
                    </div>

                    <div id="formConfirmPassword" className={styles.inputGroup}>
                        <label htmlFor="confirmPassword">Confirm password</label>
                        <input value={signUpForm.confirmPassword} onChange={onChange} className="input" type="password" id="confirmPassword" />
                    </div>

                    <div className={styles.checkboxGroup}>
                        <input ref={checkboxRef} type="checkbox" id="terms" />
